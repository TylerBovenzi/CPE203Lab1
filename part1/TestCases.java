...
public class TestCases
{
   ...
   {
      assertEquals(6.8, SimpleIf.max(4.5, 6.8), DELTA);
   }
   ...
   public void testSimpleArray3()
   {
      assertArrayEquals(
              new int[] {25, 16},
              SimpleArray.squareAll(new int[] {5, 4}));
   }
   ...
   @Test
   public void testBetterLoop3() { assertFalse(BetterLoop.contains(new int[] {7, 5, 2, 4}, 3)); }
   ...
   {
      List<String> expected = Arrays.asList("Tyler", "Chris");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();
